...
# input order of imgs: tra, cor, sag
def getCroppedIsotropicImgs(outputDirectory, resampledSpacing, bb_size, bb_factor, *imgs):
    ...
    tra_HR = utils.resampleImage(img_tra, resampledSpacing, sitk.sitkLinear,0)
    tra_HR = utils.sizeCorrectionImage(tra_HR, factor=bb_factor, imgSize=bb_size)
    ...
    start, size = sizeCorrectionBoundingBox(boundingBox, newSize=bb_size, factor=bb_factor)
    start[2] = 0
